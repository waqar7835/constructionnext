const ImgProduct = () => {
  return (
    <div
      className="hide-responsive banner-overlay section-space-banner home-banner"
        ...
        <div className="row">
          <div className="col-lg-12">
            <div className="banner-content-layout2 text-center">
              ...
              <p>
                Lam Equipment is your one-stop for NEW and pre-owned
                construction equipment:
              </p>
              <p>
                SKID STEERS, EXCAVATORS, DUMP TRAILER, TRUCKS, WHEEL LOADERS,
              ...
              <p>
                ...
                trade-ins, and construction fleet reductions. All of our
                products and machines have been well-maintained and inspected by
