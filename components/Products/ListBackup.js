          ...
          productsData.rows.map((product, index) => (
            <div key={index} className="views-row">
              <div className="invent-pro-cus">
                ...
                {/* <div className="invent-pro-cus-rt">  //// to remove for new changes
                  <div className="manf-detail">
                    ...
                    <div className="products-info-btns">
                      ...
                      {/* <EmailSellerModal /> 
                      <EmailSellerModalv title={product.title} id={product.nid}/>
                      <VideoChatModalv title={product.title} id={product.nid} />
                    </div>
                  </div>
                </div> */}
              </div>
