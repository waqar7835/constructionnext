(function ($) {
  ...
  $("nav#dropdown").meanmenu({
    siteLogo:
      "<a href='index.html' class='logo-mobile-menu'><img src='/images/logo.png' /></a>",
  });
  ...
  $(window).on("load", function () {
    ...
    if (testimonialCarousel.length) {
      testimonialCarousel.find(".testimonial-sliders").slick({
        ...
        prevArrow:
          '<span class="bst-prev bst-arrow"><i class="fa fa-long-arrow-left" aria-hidden="true"></i></span>',

        nextArrow:
          '<span class="bst-next bst-arrow"><i class="fa fa-long-arrow-right" aria-hidden="true"></i></span>',
      });
  ...
  function equalHeight() {
    ...
    $(".equal-height-wrap .item-img,.equal-height-wrap .item-content").height(
      "auto"
    );
  ...
  $("#countdown").countdown("2017/6/01", function (e) {
    $(this).html(
      e.strftime(
        "<div class='countdown-section'><h3>%D</h3> <p>Day%!D</p> </div><div class='countdown-section'><h3>%H</h3> <p>Hour%!H</p> </div><div class='countdown-section'><h3>%M</h3> <p>Min%!M</p> </div><div class='countdown-section'><h3>%S</h3> <p>Sec%!S</p> </div>"
      )
    );
  });
  ...
  $(".construction-carousel").each(function () {
    ...
    carousel.owlCarousel({
      ...
      navText: [
        "<i class='icofont icofont-swoosh-left' aria-hidden='true'></i>",
        "<i class='icofont icofont-swoosh-right' aria-hidden='true'></i>",
      ],
